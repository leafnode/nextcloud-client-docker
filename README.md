...
This image is based on the work made by: [Martin Peters](https://github.com/FreakyBytes) and [juanitomint](https://github.com/juanitomint/nextcloud-client-docker).
...
Any comment or propblem feel free to [fill an issue](https://github.com/leafnode/nextcloud-client-docker/issues/new) or make a PR!
